...
class JobFilterPanelStyles {
  ...
  JobFilterPanelStyles(BuildContext context) {}
}

class JobFilterPanelDesktopStyles extends JobFilterPanelStyles {
  JobFilterPanelDesktopStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
...
class JobFilterPanelTabletStyles extends JobFilterPanelStyles {
  JobFilterPanelTabletStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
      width: ResponsibleDesignSettings.desktopDesignWidth,
      height: ResponsibleDesignSettings.desktopDesignHeight,
...
class JobFilterPanelMobileStyles extends JobFilterPanelStyles {
  JobFilterPanelMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
